// SystemVerilog conversion of PSC_I2SRX.v
`timescale 1ns/1ps
...
module PSC_I2SRX #(
    ...
    logic [23:0] fifo_R_mem [0:FIFO_DEPTH-1];
    logic [23:0] fifo_L_mem [0:FIFO_DEPTH-1];     // not used.
