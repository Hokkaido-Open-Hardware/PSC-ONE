...
module PSC_RV32_core #(
    ...
    assign trap_scause =
        ...
        d_pf_event                             ?
            (data_fault_misaligned ?
                (data_fault_is_store ? 32'd6 : 32'd4) :
    ...
    logic branch_resolve_valid, branch_resolve_taken;
    logic [31:0] branch_resolve_pc, branch_resolve_target;
